class InsertPrograms < ActiveRecord::Migration
  def self.up
        ...
        Program.create :program_number => "3", :program_abbrev => "HAST", :program_title => "Hormone Action and Signal Transduction in Cancer", :program_category => "Basic Science", :start_date => "01-SEP-2007"
        Program.create :program_number => "4", :program_abbrev => "CGMT", :program_title => "Cancer Genes and Molecular Targeting", :program_category => "Basic Science", :start_date => "01-SEP-2007"
        Program.create :program_number => "5", :program_abbrev => "CCB",  :program_title => "Cancer Cell Biology", :program_category => "Basic Science", :start_date => "01-SEP-2007"
        ...
        Program.create :program_number => "8", :program_abbrev => "HM",   :program_title => "Hematologic Malignancies", :program_category => "Clinical", :start_date => "01-SEP-2007"
        ...
        Program.create :program_number => "11", :program_abbrev => "GI",   :program_title => "GI Oncology", :program_category => "Clinical", :start_date => "01-SEP-2008"
        Program.create :program_number => "12", :program_abbrev => "PO",  :program_title => "Pediatric Oncology", :program_category => "Clinical", :start_date => "01-SEP-2008"
