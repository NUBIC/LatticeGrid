ActionController::Routing::Routes.draw do |map|
  ...
  # manually added rjs routes to enforce .js format
    ...
    map.d3_investigator_wordle_data 'cytoscape/:id/d3_investigator_wordle_data.js', :action=>"d3_investigator_wordle_data", :controller=>"cytoscape",  :conditions => { :method => :get }
    map.d3_investigator_similarity_wordle_data 'cytoscape/:id/d3_investigator_similarity_wordle_data.js', :action=>"d3_investigator_similarity_wordle_data", :controller=>"cytoscape",  :conditions => { :method => :get }
    map.d3_investigator_difference_wordle_data 'cytoscape/:id/d3_investigator_difference_wordle_data.js', :action=>"d3_investigator_difference_wordle_data", :controller=>"cytoscape",  :conditions => { :method => :get }

    map.d3_investigator_chord_data 'cytoscape/:id/d3_investigator_chord_data.js', :action=>"d3_investigator_chord_data", :controller=>"cytoscape",  :conditions => { :method => :get }
    map.d3_all_investigators_chord_data 'cytoscape/d3_all_investigators_chord_data.js', :action=>"d3_all_investigators_chord_data", :controller=>"cytoscape",  :conditions => { :method => :get }
    map.d3_program_investigators_chord_data 'cytoscape/:id/d3_program_investigators_chord_data.js', :action=>"d3_program_investigators_chord_data", :controller=>"cytoscape",  :conditions => { :method => :get }
    
    map.d3_investigator_edge_data 'cytoscape_d3_investigator_edge_data.js', :action=>'d3_investigator_edge_data', :controller=>'cytoscape', :conditions => { :method => :get }
  ...
  # manually added html route for the top mesh terms in the tag cloud
    ...
    map.resources :abstracts, :only => [:index, :show], :collection => { :feed => :get, :search => [:get, :post], :tag_cloud => :get, :current => :get, :add_pubmed_ids => [:get, :post], :update_pubmed_id => [:get, :post], :add_abstracts => :get, :high_impact_by_month => :get, :high_impact => :get },
  ...
  map.resources :investigators, :only => [:index, :show], :member => {:full_show => :get, :show_all_tags => :get, :publications => :get, :abstract_count => :get, :show_colleagues => :get, :preview => :get, :search => :get, :investigators_search => :get, :research_summary => :get, :tag_cloud_list => :get, :title => :get, :home_department => :get, :bio=>:get, :email=>:get, :affiliations=>:get}, :collection => { :list_all => [:get, :post], :listing => :get, :list_by_ids => [:post, :get] }
  map.resources :cytoscape, :only => [:index, :show], 
    :member => {:showjs => :get, :investigators => :get, :investigator_tree=>:get, :protovis => :get, :jit => :get, :awards => :get, :studies => :get, :d3_data => :get, :investigator_wordle => :get, :simularity_wordle=> :get, :difference_wordle=>:get, :program_chord=> :get, :investigator_chord=> :get, :all_investigator_chord=> :get, :show_org=>:get, :show_org_org=>:get, :awards_org=>:get, :studies_org=>:get, :show_all=>:get, :org_all=>:get, :d3_investigator_tree_data=>:get, :d3_investigator_force_data=>:get}, 
    :collection => {:d3_data => :get, :chord_by_date => [:get, :post], :all_investigator_chord=> :get, :investigator_edge_bundling => :get, :show_all_orgs=>[:post, :get], :chord=>:get, :show_all_orgs_old=>[:post, :get], :export=>[:post, :get]}
  ...
  map.resources :profiles, :except=>[:destroy,:new], :member => {:reminder => :get, :edit_pubs => :get, :investigator_listing => [:get, :post]}, :collection => { :list_orgs => :get, :edit_orgs => [:get,:post,:put], :update_orgs => :put, :splash => :get, :recent_unvalidated => :get, :recent => :get, :ccsg => :get, :admin => :get, :list_summaries => :get, :list_summaries_by_program => [:get, :post], :list_investigators => :get, :edit_investigators => :get}
  ...
  map.org_org_cytoscape_data "org_org_cytoscape_data/:id/:depth/:include_publications/:include_awards/:include_studies", :controller => 'cytoscape', :action => 'org_org_cytoscape_data'
  map.all_org_cytoscape_data "all_org_cytoscape_data/:include_publications/:include_awards/:include_studies/:start_date/:end_date", :controller => 'cytoscape', :action => 'all_org_cytoscape_data'
  ...
  map.d3_investigator_force_data "cytoscape/:id/:depth/d3_investigator_force_data.:format", :controller => 'cytoscape', :action => 'd3_investigator_force_data'
  map.d3_investigator_tree_data "cytoscape/:id/:depth/d3_investigator_tree_data.:format", :controller => 'cytoscape', :action => 'd3_investigator_tree_data'
