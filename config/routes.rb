ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :cytoscape, :only => [:index, :show], :member => {:investigators => :get, :protovis => :get, :jit => :get, :awards => :get, :studies => :get, :d3_data => :get, :investigator_wordle => :get, :simularity_wordle=> :get, :difference_wordle=>:get, :chord=>:get, :investigator_chord=> :get, :show_org=>:get, :show_org_org=>:get, :awards_org=>:get, :studies_org=>:get, :show_all=>:get, :org_all=>:get}, :collection => {:d3_data => :get, :chord=>:get, :chord_by_date => [:get, :post], :investigator_edge_bundling => :get, :show_all_orgs=>[:post, :get], :export=>[:post, :get]}
